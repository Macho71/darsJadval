...
class Dars_jadvali extends StatefulWidget {
  const Dars_jadvali({super.key});

  @override
  State<Dars_jadvali> createState() => _Dars_jadvaliState();
}

// ignore: camel_case_types
class _Dars_jadvaliState extends State<Dars_jadvali> {
  @override
